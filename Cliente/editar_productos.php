    ...
    <div class="col-lg-6 m-auto">
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input type="file" id="foto_selector" style="display: none;">
          <button type="button" class="btn btn-secondary mt-2" onclick="document.getElementById('foto_selector').click()">Seleccionar imagen</button>
          <div id="preview" class="mt-2">
            <?php if($foto): ?>
              <img src="<?php echo $foto; ?>" alt="Foto actual" style="max-width: 200px;">
            <?php endif; ?>
          </div>
        </div>
        <div class="form-group">
...
<script>
document.getElementById('foto_selector').addEventListener('change', function(e) {
